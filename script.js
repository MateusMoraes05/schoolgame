    ...
    if (!played && !finished) {
        ...
        if (firstPlayerTime) {
            ...
            if (firstPlayerScore == 21) {
                ...
                document.getElementsByClassName("player--0")[0].style.backgroundColor = "#1B9AAA"
                document.getElementsByClassName("player--1")[0].style.backgroundColor = "#03256C"
                finished = true

            }
            else if (firstPlayerScore > 21) {
                document.getElementById("player--1--Status").innerHTML = "Vencedor"
                document.getElementsByClassName("player--0")[0].style.backgroundColor = "#03256C"
                document.getElementsByClassName("player--1")[0].style.backgroundColor = "#1B9AAA"
                finished = true
            }
        }
        else {
